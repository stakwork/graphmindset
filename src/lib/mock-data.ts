...
export const MOCK_REVIEWS: Review[] = [
  ...
  {
    ref_id: "mock-social-handle-1",
    type: "social_handle_candidate",
    rationale: "Twitter profile @satoshi is strongly associated with the Person node 'Satoshi Nakamoto' based on co-citation analysis (confidence 0.92).",
    subject_ids: ["n3"],
    subject_nodes: [{ ref_id: "n3", node_type: "Person", properties: { name: "Satoshi Nakamoto" } }],
    action_name: "add_social_handle",
    action_payload: {
      person_ref_id: "n3",
      platform: "twitter",
      handle: "@satoshi",
      source_url: "https://example.com/satoshi-twitter-evidence",
      confidence: 0.92,
    },
    status: "pending",
    fingerprint: "fp-social-handle-1",
    priority: 2,
    display_label: "twitter: @satoshi",
    accent: "blue",
    action_verb: "Add Handle",
    icon: "share-2",
    created_at: new Date(Date.now() - 1_800_000).toISOString(),
  },
  {
    ref_id: "mock-social-handle-2",
    type: "social_handle_candidate",
    rationale: "LinkedIn profile for Jack Dorsey confirmed via external source cross-reference.",
    subject_ids: ["n2"],
    subject_nodes: [{ ref_id: "n2", node_type: "Person", properties: { name: "Jack Dorsey" } }],
    action_name: "add_social_handle",
    action_payload: {
      person_ref_id: "n2",
      platform: "linkedin",
      handle: "jackdorsey",
      source_url: "https://example.com/jack-linkedin-evidence",
      confidence: 0.85,
    },
    status: "approved",
    fingerprint: "fp-social-handle-2",
    priority: 1,
    display_label: "linkedin: jackdorsey",
    accent: "blue",
    action_verb: "Add Handle",
    icon: "share-2",
    created_at: new Date(Date.now() - 86_400_000).toISOString(),
    decided_at: new Date(Date.now() - 82_800_000).toISOString(),
    decided_by: "admin-pubkey-abc",
  },
  // ── New action types ──────────────────────────────────────────────────────
  {
    ...
    status: "pending",
    priority: 2,
    rationale: "AI detected frequent references to 'Lightning DeFi' across recent episodes but no corresponding Topic node exists.",
    subject_ids: [],
    subject_nodes: [],
    action_name: "add_node",
    action_payload: { node_type: "Topic", properties: { name: "Lightning DeFi", description: "Decentralized finance applications built on the Lightning Network" } },
    fingerprint: "fp-mock-add-node-1",
  ...
  },
  {
    ...
    status: "pending",
    priority: 1,
    rationale: "Satoshi Nakamoto is consistently linked to the Bitcoin Whitepaper across transcripts but no AUTHORED_BY edge exists.",
    subject_ids: ["n3", "n6"],
    subject_nodes: [
      { ref_id: "n3", node_type: "Person", properties: { name: "Satoshi Nakamoto" } },
      { ref_id: "n6", node_type: "Topic", properties: { name: "Bitcoin Whitepaper" } },
    ...
    fingerprint: "fp-mock-add-edge-1",
  ...
  },
  {
    ...
    status: "pending",
    priority: 3,
    rationale: "Node n8 was ingested as a Clip but its duration and transcript fields match an Episode schema more closely.",
    subject_ids: ["n8"],
    subject_nodes: [{ ref_id: "n8", node_type: "Clip", properties: { name: "Bitcoin Explained (Clip)" } }],
    action_name: "edit_node",
    action_payload: { ref_id: "n8", node_type: "Episode", type_to_be_deleted: ["Clip"], properties: { name: "Bitcoin Explained" } },
    fingerprint: "fp-mock-edit-node-1",
  ...
  },
  {
    ...
    status: "pending",
    priority: 1,
    rationale: "Multiple nodes are tagged with 'framework' descriptors but no Framework schema type exists.",
    subject_ids: [],
    subject_nodes: [],
    ...
    action_payload: {
      ...
      attributes: [
        ...
        { key: "repository", type: "text", required: false },
      ],
    },
    fingerprint: "fp-mock-add-schema-type-1",
  ...
  },
  {
    ...
    status: "pending",
    priority: 0,
    rationale: "A universal MENTIONS edge type would allow any node to reference any other without per-pair schema registrations.",
    subject_ids: [],
    subject_nodes: [],
    action_name: "add_schema_edge_type",
    action_payload: { edge_type: "MENTIONS", source: "*", target: "*" },
    fingerprint: "fp-mock-add-schema-edge-1",
